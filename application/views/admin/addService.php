		...
		<div class="add_product_div row">
			...
			<div class="col s12" >
				<div class="row">
				    ...
				    <?php $fattr = array('class' => 'col s12' ); echo form_open_multipart('admin/addService',$fattr); ?>
				      <div class="row">
				        <div class="input-field col s12">
				          <input id="Service_name" type="text" class="validate" name="serviceName">
				          <label for="Service_name">Service Name</label>
				        </div>
				      </div>
				      <div class="row">
				        <div class="input-field col s12">
				          <textarea id="serviceDes" class="materialize-textarea" name="serviceDes"></textarea>
