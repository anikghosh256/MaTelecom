			...
			<div class="add_product_div row">
				...
				<div class="row valign-wrapper cyan lighten-5" style="min-height: calc(100vh - 185px); margin-top: 30px; border-radius: 15px;" >
					<div class="col s12 center">
						<h2><?php echo $sI['title']; ?></h2>
						<p><img id="imgS" style="width: 100px;" src="<?php echo base_url('uploads/slider/'.$sI['img']); ?>"></p>
						<br><hr>

						<h3 class="red-text">Are you sure ?</h3>
						<p>You want to delete this img.. </p>
						...
						<div class="row">
							...
							<div class="col s6 right">
								<a class="btn red" href="<?php echo base_url('admin/dSI/'.$sI['id']); ?>">Delete</a>
							</div>
						</div>
